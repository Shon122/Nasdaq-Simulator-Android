...
public class TradeAdapterProfile extends ArrayAdapter<Trade> {
    private ArrayList<Trade> tradeList;
    private ArrayList<Trade> originalList;

    public TradeAdapterProfile(Context context, ArrayList<Trade> tradeList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.trade_item_profile, parent, false);
        }
